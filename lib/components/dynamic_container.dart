...
import 'package:fam/components/components.dart';
...
class _DynamicContainerState extends State<DynamicContainer> {
  ...
  Widget build(BuildContext context) {
    // switch case for each card according to Design Type
    switch (widget.json['design_type']) {
            ...
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                ...
                child: Container(
                  ...
                  margin: getMargin(widget.json['cards'][index], false, false),
                ...
                child: Stack(
                  children: [
                    ...
                    AnimatedContainer(
                      ...
                      margin: getMargin(widget.json['cards'][index], true,
                          _isSlidingMap[index]!),
      ...
      // Image Card (Future Builder as it calculates dimensions of Image first for dynamic height)
      case 'HC5':
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    ...
                    child: Container(
                      margin:
                          getMargin(widget.json['cards'][index], false, false),
                      width: MediaQuery.of(context).size.width - 48,
                      decoration: BoxDecoration(
                        color: getBackgroundColor(widget.json['cards'][index]),
                        borderRadius: Constants.defaultBorderRadius,
